...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Contact - Ksenia Moroz Watercolor Artist';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Get in touch with watercolor artist Ksenia Moroz for commissions, collaborations, or art inquiries.');
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* Hero Section */}
      <section className="relative py-16 lg:py-20 overflow-hidden min-h-[50vh] -mt-28 bg-gradient-to-br from-primary-500 to-accent-500" style={{paddingTop: '8rem'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-accent-200 bg-clip-text text-transparent">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-all duration-300 border border-primary-100">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 p-5 bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl hover:shadow-lg transition-all duration-300 border-l-4 border-primary-400">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg bg-gradient-to-br from-primary-500 to-accent-500">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="text-primary-600 hover:text-accent-600 transition-colors duration-300 font-medium"
                    >
                ...
                {/* Instagram */}
                <div className="flex items-center space-x-4 p-5 bg-gradient-to-r from-accent-50 to-primary-50 rounded-2xl hover:shadow-lg transition-all duration-300 border-l-4 border-accent-400">
                  <div className="w-14 h-14 bg-gradient-to-r from-accent-500 to-primary-500 rounded-2xl flex items-center justify-center shadow-lg">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="text-accent-600 hover:text-primary-600 transition-colors duration-300 font-medium"
                    >
                      @moroz_customart
                    </a>
                  </div>
                ...
                {/* Location */}
                <div className="flex items-center space-x-4 p-5 bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl hover:shadow-lg transition-all duration-300 border-l-4 border-primary-400">
                  <div className="w-14 h-14 bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl flex items-center justify-center shadow-lg">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="rounded-full shadow-2xl p-8 text-white relative overflow-hidden bg-gradient-to-br from-primary-500 to-accent-500">
          ...
          {/* Contact Form */}
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-primary-100 relative overflow-hidden">
            {/* Decorative paint drops */}
            <div className="absolute top-4 right-4 w-3 h-3 bg-primary-300 rounded-full opacity-60"></div>
            <div className="absolute top-8 right-8 w-2 h-2 bg-accent-300 rounded-full opacity-40"></div>
            <div className="absolute bottom-6 left-6 w-4 h-4 bg-accent-300 rounded-full opacity-50"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 transition-all duration-300 bg-primary-50/50 ${
                      errors.name 
                        ? 'border-red-300 focus:ring-red-400 focus:border-red-400' 
                        : 'border-primary-200 focus:ring-primary-400 focus:border-primary-400 hover:border-primary-300'
                    }`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onBlur={handleBlur}
                  rows={6}
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 transition-all duration-300 resize-none bg-primary-50/50 ${
                    errors.message 
                      ? 'border-red-300 focus:ring-red-400 focus:border-red-400' 
                      : 'border-primary-200 focus:ring-primary-400 focus:border-primary-400 hover:border-primary-300'
                  }`}
              ...
              <button
                ...
                className="w-full text-white font-bold py-4 px-8 rounded-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-xl relative overflow-hidden bg-gradient-to-br from-primary-500 to-accent-500"
              >
        ...
        <div className="mt-16 text-center">
          <div className="rounded-full shadow-2xl p-12 text-white max-w-4xl mx-auto relative overflow-hidden bg-gradient-to-br from-accent-400 to-primary-500">
            {/* Artistic background elements */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-accent-600 font-bold py-4 px-8 rounded-2xl hover:bg-accent-50 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Follow My Art Journey
                </a>
                <a
                  href="mailto:contact@morozcustomart.com"
                  className="bg-transparent border-2 border-white text-white font-bold py-4 px-8 rounded-2xl hover:bg-white hover:text-accent-600 transform hover:scale-105 transition-all duration-300"
                >
