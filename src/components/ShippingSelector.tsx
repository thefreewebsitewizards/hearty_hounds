...
import { ShippingRate, ShippingAddress, getShippoRates } from '../services/clientShipping';
...
const ShippingSelector = forwardRef<ShippingSelectorRef, ShippingSelectorProps>(
  ({ orderTotal, connectedAccountId, onShippingSelect, selectedShippingRate, shippingAddress, cartItems }, ref) => {
    ...
    if (loading) {
      return (
        <div className="bg-white/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-slate-200 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-chewy text-xl font-bold text-slate-800">
          ...
          <div className="bg-primary-50 border border-primary-200 rounded-xl p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="font-spartan text-primary-700 font-medium">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 shadow-lg">
          ...
          <div className="bg-primary-50 border border-primary-200 rounded-xl p-4">
            <div className="text-center">
              ...
              <p className="font-spartan text-primary-700 font-medium mb-2">
                Enter your shipping address above to see available shipping options
              </p>
              <p className="font-spartan text-primary-600 text-sm">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-red-200 shadow-lg">
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-4">
            <div className="text-center">
              ...
              <p className="font-spartan text-red-700 text-sm font-medium mb-2">Unable to Calculate Shipping</p>
              <p className="font-spartan text-red-600 text-xs leading-relaxed">{error}</p>
              <div className="mt-4">
                <button
                  onClick={refreshRates}
                  className="font-chewy px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors duration-200 text-sm font-medium"
                >
                  🔄 Try Again
                </button>
              </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 shadow-lg">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
            <div className="text-center">
              ...
              <h4 className="font-chewy text-lg font-bold text-slate-700 mb-2">No Shipping Options Found</h4>
              <p className="font-spartan text-slate-600 text-sm leading-relaxed mb-4">
                We couldn't find shipping options for your address. Please check your address details and try again.
              </p>
              <div className="bg-primary-50 border border-primary-200 rounded-lg p-3">
                <p className="font-spartan text-primary-700 text-xs">
    ...
    return (
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-chewy text-lg sm:text-xl font-bold text-slate-800">
              📦 Choose Shipping Option
            </h3>
            <p className="font-spartan text-slate-600 text-sm">
        ...
        {qualifiesForFreeShipping && (
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-chewy text-green-700 font-bold text-xs sm:text-sm">
                  🎉 Congratulations! Free Shipping Unlocked
                </p>
                <p className="font-spartan text-green-600 text-xs">
        ...
        <div className="space-y-3 sm:space-y-4">
          {shippingRates.map((rate, index) => {
            ...
            return (
              <div
                key={rate.id}
                className={`group relative cursor-pointer transition-all duration-300 transform hover:scale-[1.02] rounded-xl p-3 sm:p-4 ${
                  isSelected
              ...
              >
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <h4 className="font-chewy font-bold text-slate-800 text-sm sm:text-base truncate">
                          {rate.display_name}
                        </h4>
                        {rate.amount === 0 && (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className="font-spartan text-slate-600 text-xs sm:text-sm">
                  ...
                  <div className="text-right flex-shrink-0">
                    <div className={`font-chewy font-bold text-base sm:text-lg transition-colors duration-200 ${
                      rate.amount === 0 ? 'text-green-600' : 'text-slate-800'
                    }`}>
                      {rate.amount === 0 ? 'Free' : formatShippingAmount(rate.amount, rate.currency)}
                    </div>
                    {rate.amount > 0 && (
                      <p className="font-spartan text-slate-500 text-xs mt-1 whitespace-nowrap">USD</p>
                    )}
                  </div>
                </div>
